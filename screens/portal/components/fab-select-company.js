...
import { Modal, Pressable, ScrollView, SectionList, Text, TouchableOpacity, View } from "react-native"
...
export const FabSelectCompany = ({ router }) => {
    ...
    return <>
        ...
        <Modal
            ...
            visible={isOpen}
        >
            <View style={tw`bg-white shadow rounded-[20px] py-40 mx-3 bottom-0 top-0 my-auto overflow-hidden`}>
